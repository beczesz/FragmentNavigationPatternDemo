package com.exarlabs.android.fragmentnavigationdemo.ui.module2;
...
public class Module2Fragment extends BaseFragment {
    ...
    private static final String TAG = Module2Fragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.module2_layout, null);
        }
        return mRootView;
    }
